...
**Rationale:** A commit message is a durable claim about a change. If the author isn't sure the change works, the fix is to verify first, not to caveat. This validator enforces the same evidence-before-claims discipline backpressure applies to tests.
